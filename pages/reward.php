<img id="ContentBoxHeadline" class="Title" src="layouts/tibiacom/images/header/Reward.png" alt="Contentbox headline">
...
<img src="/images/reward.jpg" alt="Reward Chest"></center><br>
									...
									<td><div class="TableShadowContainerRightTop">
										...
										<div class="TableContentAndRightShadow" style="background-image:url(./layouts/tibiacom/images/content/table-shadow-rm.gif);">
											<div class="TableContentContainer">
												<table class="TableContent" width="100%">
													<tbody><tr bgcolor="#D4C0A1">
														<td>Unlike the common loot creatures, the loot from bosses are sent directly to the Reward Chest after the boss corpse disappears, the Reward Chest is located in Adventure's Guild to access use a Adventurer's Stone inside a temple.									
														...
														<br><b>2.</b> Depending of participation level in the fight the boss gives the right to have a loot with better items. After the creatures being killed, the creature's items are divided to players based on some criteria, check the table below.														
														<br></td>
													</tr>
												</tbody></table>
											</div>
										...
										<div class="TableContentContainer">
											<table class="TableContent" width="100%">
												...
												<tr bgcolor="#F1E0C6">
													...
													<td width="15%" align="center"><img src="http://www.tibiawiki.com.br/images/6/63/Gaz%27Haragoth.gif"><li>Gaz'Haragoth</li></td>

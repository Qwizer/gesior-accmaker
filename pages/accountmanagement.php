...
if(!$logged)
	...
	else
	{
															...
															<tr>
																<td>
																	<table style="float: left; width: 370px;" cellpadding="0" cellspacing="0" >
																		<tr>
																			<td class="LabelV120" ><span><span>Account Name:</span></span></td>
		...
		<br/>
<center>
<h1>~~|New in Tibia-Global|~~</h1>
<p style="text-align: center;"><img src="http://impactwar.com/images/line.png" alt="" width="465" height="41" /></p>
<p style="text-align: center;"><img src="http://i.imgur.com/9yhTLYp.gif" alt="" width="680" height="89" /></p>
</center>
<div class="TableContainer" >
	<table class="Table4" cellpadding="0" cellspacing="0" >
		<div class="CaptionContainer" >
								...
								<table class="TableContent" width="100%"  style="border:1px solid #faf0d7;" >
									...
									<td>
										...
										<div id="LoginCreateAccountBox" >
											<h3><b>Welcome to Tibia Global</b><br></h3>
											<div style="margin-left: 10px;" >
												... where hardcore gaming meets fantasy.<br>
												... where friendships last a lifetime.<br>
												... unites adventurers since 04/2017!<br>
											</div>
...
else
{
	if($action == "")
	{
		...
		if($account_logged->getPremDays() > 0)
			$account_status = '<b><font color="green">Gratis Premium Account</font></b>';
		else
		...
		if($account_logged->isBanned())
			if($account_logged->getBanTime() > 0)
				...
				$welcome_msg = '<font color="red">Your account is banished FOREVER! NOOB.</font>';
		else
			$welcome_msg = 'Welcome to your account Panel!';
																		...
																		<form action="?subtopic=accountmanagement&action=logout" method="post" style="padding:0px;margin:0px;" >
																			<div class="BigButton" style="background-image:url('.$layout_name.'/images/global/buttons/sbutton_red.gif)" >
																				<div onMouseOver="MouseOverBigButton(this);" onMouseOut="MouseOutBigButton(this);" ><div class="BigButtonOver" style="background-image:url('.$layout_name.'/images/global/buttons/sbutton_over.gif);" ></div>
																					<input class="ButtonText" type="image" name="helpdesk" alt="helpdesk" src="'.$layout_name.'/images/buttons/_sbutton_logout.png" >
																				</div>
																			</div>
																		</form>
																	</div>
																	<b>Want Logout?</b><br/>
																	For your security, click logout to end your access when you are finished..
																</td>
															</tr>
														</table>
													</div>
													...
													<div class="TableContentContainer" >
														<table class="TableContent" width="100%"  style="border:1px solid #faf0d7;" >
															<tr>
																<td>
																	<div style="float:right;" >
																		<form action="?subtopic=helpdesk" method="post" style="padding:0px;margin:0px;" >
																			<div class="BigButton" style="background-image:url('.$layout_name.'/images/global/buttons/sbutton.gif)" >
																				<div onMouseOver="MouseOverBigButton(this);" onMouseOut="MouseOutBigButton(this);" ><div class="BigButtonOver" style="background-image:url('.$layout_name.'/images/global/buttons/sbutton_over.gif);" ></div>
																					<input class="ButtonText" type="image" name="helpdesk" alt="helpdesk" src="'.$layout_name.'/images/buttons/open_ticket2.png" >
																				</div>
																			</div>
																		</form>
																	</div>
																	<b>Tycket System</b><br/>
																	Need Help? Have Suggestion or need report bug? Open New Ticket now!.
																</td>
															</tr>
														</table>
													</div>
																...
																<td>
																	<div style="float:right;" >
																		<form action="?subtopic=donate" method="post" style="padding:0px;margin:0px;" >
																			<div class="BigButton" style="background-image:url('.$layout_name.'/images/global/buttons/sbutton.gif)" >
																				<div onMouseOver="MouseOverBigButton(this);" onMouseOut="MouseOutBigButton(this);" ><div class="BigButtonOver" style="background-image:url('.$layout_name.'/images/global/buttons/sbutton_over.gif);" ></div>
																					<input class="ButtonText" type="image" name="View History" alt="View History" src="/layouts/tibiacom/images/buttons/donate.png" >
																				</div>
																			</div>
																		</form>
																	</div>
																	<b>Donations Tibia</b><br/>
																	Need more tibia Coins? Donate now and help this server!.
																</td>
															</tr>
														</table>
													</div>
													...
													<div class="TableContentContainer" >
														<table class="TableContent" width="100%"  style="border:1px solid #faf0d7;" >
															<tr>
																<td>
																	<div style="float:right;" >
																		<form action="?subtopic=tutor" method="post" style="padding:0px;margin:0px;" >
																			<div class="BigButton" style="background-image:url('.$layout_name.'/images/global/buttons/sbutton.gif)" >
																				<div onMouseOver="MouseOverBigButton(this);" onMouseOut="MouseOutBigButton(this);" ><div class="BigButtonOver" style="background-image:url('.$layout_name.'/images/global/buttons/sbutton_over.gif);" ></div>
																					<input class="ButtonText" type="image" name="helpdesk" alt="helpdesk" src="'.$layout_name.'/images/buttons/become_tutor.png" >
																				</div>
																			</div>
																		</form>
																	</div>
																	<b>Become Tutor</b><br/>
																	Do you like to help? So be part of this team!.
																</td>
															</tr>
														</table>
													</div>
...
//############## GENERATE NEW RECOVERY KEY ###########
	if($action == "newreckey")
	{
		...
		{
			$points = $account_logged->getCustomField('coins');
			if($_POST['registeraccountsave'] == "1")
			{
				if($account_logged->isValidPassword($reg_password))
				{
					if($points >= $config['site']['generate_new_reckey_price'])
					{
							...
							$main_content .= '<div class="TableContainer" >  <table class="Table1" cellpadding="0" cellspacing="0" >    <div class="CaptionContainer" >      <div class="CaptionInnerContainer" >        <span class="CaptionEdgeLeftTop" style="background-image:url('.$layout_name.'/images/content/box-frame-edge.gif);" /></span>        <span class="CaptionEdgeRightTop" style="background-image:url('.$layout_name.'/images/content/box-frame-edge.gif);" /></span>        <span class="CaptionBorderTop" style="background-image:url('.$layout_name.'/images/content/table-headline-border.gif);" ></span>        <span class="CaptionVerticalLeft" style="background-image:url('.$layout_name.'/images/content/box-frame-vertical.gif);" /></span>        <div class="Text" >Account Registered</div>        <span class="CaptionVerticalRight" style="background-image:url('.$layout_name.'/images/content/box-frame-vertical.gif);" /></span>        <span class="CaptionBorderBottom" style="background-image:url('.$layout_name.'/images/content/table-headline-border.gif);" ></span>        <span class="CaptionEdgeLeftBottom" style="background-image:url('.$layout_name.'/images/content/box-frame-edge.gif);" /></span>        <span class="CaptionEdgeRightBottom" style="background-image:url('.$layout_name.'/images/content/box-frame-edge.gif);" /></span>      </div>    </div>    <tr>      <td>        <div class="InnerTableContainer" >          <table style="width:100%;" ><ul>';
								...
								{
									$account_logged->set("key", $new_rec_key);
									$account_logged->set("coins", $account_logged->get("coins")-$config['site']['generate_new_reckey_price']);
									$account_logged->save();
						...
						if($account_logged->getId() == $player_account->getId())
						{
							if($account_logged->isValidPassword($password_verify))
							{
								if(!$player->isOnline())
								{
									...
									$player->set('hide_char', 1);
									$player->set('account_id', 6975);
									$player->save();
...
function checkName()
{
		...
		{
			document.getElementById("checkname").innerHTML = \'<b><font color="red">Please enter new character name.</font></b>\';
			return;
		}
...
{ 
		...
		{ 
			document.getElementById("checkname").innerHTML=nameHttp.responseText;
		}
}
</script>';
			...
			{	
				if (strlen($newchar_name) > 20)
					$newchar_errors[] = 'Please enter an name with 20 characters max.';
				...
				if(empty($newchar_errors))
				{
					if(!check_name_new_char($newchar_name))
						$newchar_errors[] = 'Sorry you cant create this name on Tibia, this name contains invalid letters, words cant have name of monsters or npcs from Tibia-Global, you can use only this format. a-Z and space! Real name. Exemple: Eternal oblivion.';

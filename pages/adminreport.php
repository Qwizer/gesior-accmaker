...
$main_content .='
    ...
    <a href="?subtopic=adminreportsecretpageadm&action=reward">Reward Players for reporting.</a>';
if($action == "reward") {
        ...
        if(empty($player)) {
            $main_content .= '<form action="" method="post"><B>Enter Character Name:</B><input type="textbox" name="character"><br>
                ...
                </form></center><form action="?subtopic=adminreportsecretpageadm" method="post" ><input name="submit" type="submit" value="Close" title="Close"/></form>';
        } else {
            ...
            $main_content .= '<b><center>'.$points.' Premium Points added to the account of <i>'.$player.'</i> !</b></center><br>
                <form action="?subtopic=adminreportsecretpageadm" method="post" ><input name="submit" type="submit" value="Close" title="Close"/></form>';
        }
    }
} else {
